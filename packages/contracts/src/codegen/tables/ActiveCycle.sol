...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ActiveCycle")));
bytes32 constant ActiveCycleTableId = _tableId;
...
library ActiveCycle {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ActiveCycle", _fieldNames);
  }
