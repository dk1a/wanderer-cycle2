...
library FromEqptBase {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "FromEqptBase", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000046726f6d457170744261736500000000);
