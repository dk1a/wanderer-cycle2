...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AvailableSkills")));
bytes32 constant AvailableSkillsTableId = _tableId;

library AvailableSkills {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AvailableSkills", _fieldNames);
  }
