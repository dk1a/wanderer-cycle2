...
library FromPrototype {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "FromPrototype", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000046726f6d50726f746f74797065000000);
