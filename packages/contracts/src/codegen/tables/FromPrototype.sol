...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("FromPrototype")));
bytes32 constant FromPrototypeTableId = _tableId;
...
library FromPrototype {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("FromPrototype", _fieldNames);
  }
