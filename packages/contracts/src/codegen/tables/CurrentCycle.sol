...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CurrentCycle")));
bytes32 constant CurrentCycleTableId = _tableId;
...
library CurrentCycle {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CurrentCycle", _fieldNames);
  }
