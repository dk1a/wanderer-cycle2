...
library MapBase {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MapBase", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d617042617365000000000000000000);
