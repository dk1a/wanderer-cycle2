...
library CycleTurnsLastClaimed {
  ...
  /** Get value */
  function get(bytes32 entity) internal view returns (uint48 value) {
  ...
  function get(IStore _store, bytes32 entity) internal view returns (uint48 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Set value */
  function set(bytes32 entity, uint48 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
