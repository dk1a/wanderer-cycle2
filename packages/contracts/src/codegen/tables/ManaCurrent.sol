...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ManaCurrent")));
bytes32 constant ManaCurrentTableId = _tableId;
...
library ManaCurrent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ManaCurrent", _fieldNames);
  }
