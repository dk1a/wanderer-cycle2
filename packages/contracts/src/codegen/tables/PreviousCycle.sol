...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PreviousCycle")));
bytes32 constant PreviousCycleTableId = _tableId;

library PreviousCycle {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PreviousCycle", _fieldNames);
  }
