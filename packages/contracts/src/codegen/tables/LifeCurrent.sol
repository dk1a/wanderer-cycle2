...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("LifeCurrent")));
bytes32 constant LifeCurrentTableId = _tableId;
...
library LifeCurrent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("LifeCurrent", _fieldNames);
  }
