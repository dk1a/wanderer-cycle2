...
FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x005604001414200e000000000000000000000000000000000000000000000000
);
...
library GameConfig {
  ...
  function getValueSchema() internal pure returns (Schema) {
    ...
    _valueSchema[3] = SchemaType.BYTES14;
  ...
  function decodeStatic(
    ...
    tokenAddress = (address(Bytes.slice20(_blob, 20)));

    tokenId = (uint256(Bytes.slice32(_blob, 40)));

    namespace = (Bytes.slice14(_blob, 72));
  }
