...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("FromStatmodBase")));
bytes32 constant FromStatmodBaseTableId = _tableId;

library FromStatmodBase {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("FromStatmodBase", _fieldNames);
  }
