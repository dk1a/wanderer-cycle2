...
library AffixAvailable {
  ...
  function push(IStore _store, AffixPartId affixPart, bytes32 targetEntity, uint32 ilvl, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(uint8(affixPart)));
    _keyTuple[1] = bytes32((targetEntity));
    _keyTuple[2] = bytes32(uint256((ilvl)));
  ...
  function pop(IStore _store, AffixPartId affixPart, bytes32 targetEntity, uint32 ilvl) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(uint8(affixPart)));
    _keyTuple[1] = bytes32((targetEntity));
    _keyTuple[2] = bytes32(uint256((ilvl)));
  ...
  function deleteRecord(IStore _store, AffixPartId affixPart, bytes32 targetEntity, uint32 ilvl) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(uint8(affixPart)));
    _keyTuple[1] = bytes32((targetEntity));
    _keyTuple[2] = bytes32(uint256((ilvl)));
