...
// import { MapPrototypes } from "./MapPrototypes.sol";

// library LibSpawnMaps {
//   function init() private {
//     _createNewMapPrototype(MapPrototypes.GLOBAL_BASIC);
//     _createNewMapPrototype(MapPrototypes.GLOBAL_RANDOM);
//     _createNewMapPrototype(MapPrototypes.GLOBAL_CYCLE_BOSS);
//   }
