...
library LibInitEquipmentAffix {
  ...
  function _allEquipment() internal pure returns (bytes32[] memory r) {
    r = new bytes32[](9);
    r[0] = EquipmentType.unwrap(EquipmentTypes.WEAPON);
    r[1] = EquipmentType.unwrap(EquipmentTypes.SHIELD);
    r[2] = EquipmentType.unwrap(EquipmentTypes.HAT);
    r[3] = EquipmentType.unwrap(EquipmentTypes.CLOTHING);
    r[4] = EquipmentType.unwrap(EquipmentTypes.GLOVES);
    r[5] = EquipmentType.unwrap(EquipmentTypes.PANTS);
    r[6] = EquipmentType.unwrap(EquipmentTypes.BOOTS);
    r[7] = EquipmentType.unwrap(EquipmentTypes.AMULET);
    r[8] = EquipmentType.unwrap(EquipmentTypes.RING);
  }

  function _jewellery() internal pure returns (bytes32[] memory r) {
    r = new bytes32[](2);
    r[0] = EquipmentType.unwrap(EquipmentTypes.AMULET);
    r[1] = EquipmentType.unwrap(EquipmentTypes.RING);
  }
  ...
  function _attrEquipment() internal pure returns (bytes32[] memory r) {
    ...
    r[1] = EquipmentType.unwrap(EquipmentTypes.SHIELD);
    r[2] = EquipmentType.unwrap(EquipmentTypes.HAT);
    r[3] = EquipmentType.unwrap(EquipmentTypes.AMULET);
  }
  ...
  function _resEquipment() internal pure returns (bytes32[] memory r) {
    r = new bytes32[](6);
    r[0] = EquipmentType.unwrap(EquipmentTypes.SHIELD);
    r[1] = EquipmentType.unwrap(EquipmentTypes.HAT);
    r[2] = EquipmentType.unwrap(EquipmentTypes.CLOTHING);
    r[3] = EquipmentType.unwrap(EquipmentTypes.GLOVES);
    r[4] = EquipmentType.unwrap(EquipmentTypes.PANTS);
    r[5] = EquipmentType.unwrap(EquipmentTypes.BOOTS);
  }
